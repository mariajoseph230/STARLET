...
//         	};
//   const products = [
//     { id: 1, name: 'Tomato', quantity: ' 1 kg', seller: 'Diya', price: 10, contact: '+1234567890' },
//     { id: 2, name: 'Potato', quantity: ' 1 kg',seller: 'Archana', price: 15, contact: '+9876543210' },
//     { id: 3, name: 'Chilli', quantity: ' 1 kg', seller: 'Manasi', price: 20, contact: '+1234509876' }
//   ];
...
//             </select>
//             <button className="buy-button" onClick={() => handleBuyClick(product.contact)}>Buy</button>
//           </div>
